...
-- =============================================================================
-- Cleanup Script - Stop Billing for Streamlit Container Service
-- =============================================================================
...
--
-- NOTE: If other services (e.g., echo_service) are using the same compute pool
--       and warehouse, suspending them will affect those services too.
-- =============================================================================

-- Step 1: Drop the service (stops service billing)
-- =============================================================================
DROP SERVICE IF EXISTS streamlit_demo_service;
