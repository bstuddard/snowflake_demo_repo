CREATE OR REPLACE PROCEDURE etl.table_updater(table_name VARCHAR, batch_id VARCHAR DEFAULT NULL, type_1_column_names VARCHAR DEFAULT NULL, enable_deletes BOOLEAN DEFAULT FALSE)
RETURNS VARCHAR
LANGUAGE PYTHON
